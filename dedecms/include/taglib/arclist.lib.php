...
function lib_arclist( &$ctag, &$refObj )
{
    ...
    return lib_arclistDone
           (
             ...
             $tagid,$pagesize,$isweight,$ctag->GetAtt('where')
           );
}
...
function lib_arclistDone(&$refObj, &$ctag, $typeid=0, $row=10, $col=1, $titlelen=30, $infolen=160,
        ...
        $innertext='', $arcid=0, $idlist='', $channelid=0, $limit='', $att='', $order='desc', $subday=0, $noflag='',$tagid='', $pagesize=0, $isweight='N', $where='')
{
	...
	//添加自定义的排序字段
	else if($orderby == 'score') $ordersql = " order by score $orderWay";
    else if($orderby == 'aid') $ordersql = " order by arc.id $orderWay";
