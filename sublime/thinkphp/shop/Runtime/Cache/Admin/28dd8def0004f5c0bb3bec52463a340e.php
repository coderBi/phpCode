...
<html>
    ...
    <body>
        ...
        <div class="div_head">
            <span>
                ...
                <span style="float:right;margin-right: 8px;font-weight: bold">
                    <a style="text-decoration: none" href="/sublime/thinkphp/shop/index.php/Admin/Goods/showlist">【返回】</a>
                </span>
            </span>
        </div>
        <div></div>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="/sublime/thinkphp/shop/index.php/Admin/Goods/addGoods" method="post" enctype="multipart/form-data">
            <table border="1" width="100%" class="table_a">
                ...
                <tr>
                    <td>商品图片</td>
                    <td><input type="file" name="f_goods_image" value="<?php echo IMG_URL; ?>2013-12-33.jpg" /></td>
                </tr>
                <tr>
                    <td>商品详细描述</td>
                    <td>
